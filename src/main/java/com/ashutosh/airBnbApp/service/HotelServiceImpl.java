...
import com.ashutosh.airBnbApp.dto.*;
import com.ashutosh.airBnbApp.entity.Hotel;
...
import com.ashutosh.airBnbApp.repository.HotelRepository;
import com.ashutosh.airBnbApp.repository.InventoryRepository;
import com.ashutosh.airBnbApp.repository.RoomRepository;
    ...
    public HotelInfoDto getHotelInfoById(Long hotelId, HotelInfoRequestDto hotelInfoRequestDto) {
        ...
        List<RoomPriceResponseDto> rooms = roomPriceDtoList.stream()
                .map(roomPriceDto -> {
                    ...
                    roomPriceResponseDto.setPrice(roomPriceDto.getPrice().doubleValue());
